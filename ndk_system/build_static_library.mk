...
STATIC_TARGET_S_OBJ = $(patsubst %.S, %.o, $(filter %.S, $(LOCAL_SRC_FILES)))
...
all: $(STATIC_TARGET)
$(STATIC_TARGET):$(STATIC_TARGET_C_OBJ) $(STATIC_TARGET_S_OBJ) $(STATIC_TARGET_CPP_OBJ)
	@$(TARGET_AR) rcs $@ $^
