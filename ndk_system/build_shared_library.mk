...
SHARED_TARGET_S_OBJ = $(patsubst %.S, %.o, $(filter %.S, $(LOCAL_SRC_FILES)))
...
all: $(SHARED_TARGET)
$(SHARED_TARGET):$(SHARED_TARGET_C_OBJ) $(SHARED_TARGET_S_OBJ) $(SHARED_TARGET_CPP_OBJ)
